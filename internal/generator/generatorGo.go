...
// сохраняет 'gentmp/.gitlab-ci.yml' и печатает его в консоль.
func GenerateGoPipeline(repoName string, analysis *analyzer.ProjectAnalysisResult) error {
